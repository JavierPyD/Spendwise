...
const styles = StyleSheet.create({
  ...
  stepDot: { width: 28, height: 28, borderRadius: 14, backgroundColor: P.blush, justifyContent: 'center', alignItems: 'center' },
  stepDotActive: { backgroundColor: P.navyDeep },
  stepDotText: { fontSize: 12, fontWeight: '700', color: P.textMuted },
  stepDotTextActive: { color: '#FFF' },
  stepLabel: { fontSize: 10, color: P.textMuted, fontWeight: '600' },
  stepLabelActive: { color: P.navyDeep },
  progressBarBg: { height: 3, backgroundColor: P.blush, marginHorizontal: 20, borderRadius: 2, marginBottom: 16 },
  progressBarFill: { height: '100%', backgroundColor: P.navyDeep, borderRadius: 2 },
  scroll: { paddingHorizontal: 24, paddingBottom: 20 },
  stepContent: { alignItems: 'center' },
  emoji: { fontSize: 56, marginBottom: 12, marginTop: 8 },
  title: { fontSize: 24, fontWeight: '800', color: P.navyDeep, textAlign: 'center', marginBottom: 8 },
  subtitle: { fontSize: 14, color: P.textMid, textAlign: 'center', lineHeight: 20, marginBottom: 24, paddingHorizontal: 8 },
  featureList: { width: '100%', gap: 12 },
  featureRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: P.white, borderRadius: 14, padding: 14, gap: 12, elevation: 1, shadowColor: P.navyDeep, shadowOpacity: 0.06, shadowRadius: 4, shadowOffset: { width: 0, height: 1 } },
  featureIcon: { fontSize: 22 },
  featureText: { fontSize: 14, fontWeight: '600', color: P.navyDeep, flex: 1 },
  fieldLabel: { alignSelf: 'flex-start', fontSize: 13, fontWeight: '700', color: P.textMid, marginBottom: 6, marginTop: 4 },
  input: { width: '100%', backgroundColor: P.white, borderRadius: 12, padding: 13, borderWidth: 1, borderColor: P.blush, fontSize: 15, color: P.textDark, marginBottom: 14 },
  currencyRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginBottom: 10, alignSelf: 'flex-start' },
  currencyBtn: { paddingHorizontal: 16, paddingVertical: 10, borderRadius: 12, backgroundColor: P.blush },
  currencyBtnActive: { backgroundColor: P.navyDeep },
  currencyText: { fontSize: 15, fontWeight: '700', color: P.textMid },
  currencyTextActive: { color: '#FFF' },
  budgetRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: P.white, borderRadius: 12, padding: 12, marginBottom: 8, width: '100%', borderWidth: 1, borderColor: P.blush },
  budgetRowActive: { borderColor: P.navyDeep },
  budgetCheck: { marginRight: 10 },
  budgetCheckText: { fontSize: 18 },
  budgetCat: { flex: 1, fontSize: 13, fontWeight: '600', color: P.navyDeep },
  budgetInputWrap: { flexDirection: 'row', alignItems: 'center', backgroundColor: P.offWhite, borderRadius: 8, paddingHorizontal: 8, borderWidth: 1, borderColor: P.blush },
  currencyPrefix: { fontSize: 13, color: P.textMuted, marginRight: 2 },
  budgetInput: { width: 60, fontSize: 14, fontWeight: '700', color: P.navyDeep, padding: 6 },
  skipNote: { fontSize: 12, color: P.textMuted, marginTop: 8, textAlign: 'center' },
  navRow: { flexDirection: 'row', paddingHorizontal: 24, paddingBottom: 32, paddingTop: 12, gap: 12 },
  backBtn: { flex: 1, padding: 14, borderRadius: 14, backgroundColor: P.blush, alignItems: 'center' },
  backBtnText: { fontWeight: '700', color: P.textMid, fontSize: 15 },
  nextBtn: { flex: 2, padding: 14, borderRadius: 14, backgroundColor: P.navyDeep, alignItems: 'center' },
  nextBtnText: { fontWeight: '700', color: '#FFF', fontSize: 15 },
  finishBtn: { flex: 2, padding: 14, borderRadius: 14, backgroundColor: P.rose, alignItems: 'center' },
